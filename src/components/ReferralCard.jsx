        ...
        <div className="flex-1 p-3 sm:p-4 min-w-0">
          ...
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-cyan-400 font-normal text-base truncate">{username}</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-x-2 sm:gap-x-4 gap-y-1 text-xs sm:text-sm">
            ...
            <div className="text-right overflow-hidden">
              <span className="text-white font-extralight text-xs sm:text-sm truncate block">
                {id}
              </span>
            </div>
            ...
            <div>
              <span className="text-white/50 font-extralight text-xs sm:text-sm truncate">
                Referral Code
              </span>
            </div>
            <div className="text-right">
