  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className={`w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-colors ${
              colorMode === 'orange'
                ...
                : 'bg-[#1F1F20] border-l border-t border-r border-white/10 text-white/50 hover:bg-slate-600'
            }`}
          >
            U
          </button>
        ...
        <div className="flex items-center gap-2">
          <button className="w-8 h-8 bg-[#4E4F50] border-l border-t border-r border-white/10 rounded-lg flex items-center justify-center hover:bg-slate-600">
          ...
          <button
            ...
            className="w-14 h-8 bg-[#1F1F21] border-t border-white/10 rounded-lg flex items-center justify-center hover:bg-slate-600"
          >
      ...
      <div className="bg-[#24282D] border border-white/10 rounded-xl p-4 min-h-[400px] relative">
        ...
        <div className="flex items-center gap-2 mb-4">
          <span className="text-white  text-sm bg-[#363636] border-l border-t border-white/10 px-3 py-1 rounded shadow-[0_2px_6px_rgba(0,0,0,0.45)]">
            {zoom}%
          </span>
          <button
            onClick={handleZoomIn}
            className="w-7 h-7 bg-[#4E4F50] border-l border-t  border-white/10 rounded flex items-center justify-center hover:bg-slate-600 transition-colors shadow-[0_2px_6px_rgba(0,0,0,0.45)]"
          >
          ...
          <button
            ...
            className="w-7 h-7 bg-[#383838] border-l border-t  border-white/10 rounded flex items-center justify-center hover:bg-slate-600 ml-auto transition-colors shadow-[0_2px_6px_rgba(0,0,0,0.45)]"
          >
