...
export default function BuyCardContent({ onBack }) {
  ...
  return (
    <div className="text-white">
      ...
      {/* Card Display */}
      <div className="flex flex-col items-center mb-8 ml-4 sm:ml-8">
        <div className="w-72 sm:w-80 lg:w-96 h-[360px] sm:h-[400px] lg:h-[440px] mb-4 flex items-center justify-center pl-8 sm:pl-8">
          <img
        ...
        <div className="bg-[#24282D] border border-white/10 rounded-2xl px-16 py-4 text-center">
          <h2 className="text-white text-lg mb-2">CRYPTO FELLAS MEMBERSHIP CARD</h2>
      ...
      >
        ...
        <div className="mb-6">
          ...
          <button
            ...
            className="w-full border border-white/20 bg-[#4F66D7] hover:[#4F66D7] text-white py-3 rounded-lg font-normal transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="mb-6">
          <h3 className="text-white text-medium font-light mb-4">Card Recipient Information</h3>
        ...
        {/* Billing Address */}
        <div className="mb-6">
          <h3 className="text-white text-medium font-light mb-4">Billing Address</h3>
          <div className="space-y-3">
            <select
              value={formData.country}
              onChange={(e) => handleInputChange('country', e.target.value)}
          ...
          <div className="mb-6 space-y-1">
            <div className="flex items-start gap-2">
              ...
              <span className="text-xs text-white/50">
                The information you provide is securely transmitted to the card company
                (fellascard.com) and is not stored by this service.
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-white/50 text-lg leading-none mt-0">•</span>
            ...
            <div className="flex items-start gap-2">
              <span className="text-white/50 text-lg leading-none mt-0">•</span>
              <span className="text-xs text-white/50">
                Please enter your address accurately. Incorrect information may result in delivery
                failure.
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-white/50 text-lg leading-none mt-0">•</span>
              <span className="text-xs text-white/50">
                Physical cards are shipped directly by the card company, and delivery schedules may
                vary according to their policies.
              </span>
            </div>
          </div>
