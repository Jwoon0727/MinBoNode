    ...
    "
        ...
        <div className="bg-[#2A2F35] border rounded-2xl p-2 sm:p-2">
          ...
          <div className="space-y-2">
            {tickets.map((ticket) => (
              <div key={ticket.id} className="bg-white/10 border border-white/10 rounded-lg p-4">
                {/* Ticket Header */}
                <div className="flex items-center gap-3 mb-3">
                  {/* Vertical Bar */}
                  <div className="w-[3px] h-6 bg-cyan-400 rounded-full" />

                  <h3 className="text-cyan-400 font-semibold">{ticket.ticketId}</h3>
                </div>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={handleTicketCancel}
                className="
    ml-auto w-5 h-5 flex items-center justify-center
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="text-white/50 text-sm">Support.dragAndDrop</div>
                      <div className="text-white/70 text-xs">Support.imageLimit</div>
                      <label
                        htmlFor="file-upload"
