  ...
  return (
        ...
        <>
          ...
          <div className="bg-[#24282D] border-l border-t border-r border-white/15 rounded-xl overflow-hidden mb-4">
            ...
            <div className="flex items-center gap-3 px-4 py-3">
              ...
              <span className="text-cyan-400 font-normal text-base">Total Bonus</span>
            </div>
    ...
    "
      ...
      {activeSubTab === 'Direct Bonus' && (
        <>
          {/* Direct Bonus Header */}
          <div className="bg-[#24282D] border-l border-t border-r border-white/15 rounded-lg px-4 py-3 mb-4">
            <div className="flex items-center gap-3">
              <div className="w-[2px] h-4 bg-cyan-400 rounded-full" />

              <span className="text-cyan-400 font-normal text-base">Direct Bonus: 0.00</span>
            </div>
          </div>
        ...
        <>
          ...
          <div className="bg-[#24282D] border-l border-t border-r border-white/15 rounded-lg px-4 py-3 mb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-cyan-400 font-normal text-base">Matching Bonus: 0.00</span>
            </div>
          </div>
        ...
        <>
          ...
          <div className="bg-[#24282D] border-l border-t border-r border-white/15 rounded-lg px-4 py-3 mb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-cyan-400 font-normal text-base">Special Bonus: 0.00</span>
            </div>
          </div>
        ...
        <>
          ...
          <div className="bg-[#24282D] border-l border-t border-r border-white/15 rounded-lg px-4 py-3 mb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-cyan-400 font-normal text-base">Card Bonus: 0.00</span>
            </div>
          </div>
