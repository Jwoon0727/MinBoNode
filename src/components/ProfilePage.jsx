    ...
    <main className="flex-1 p-4 lg:p-8 overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <button className="w-full max-w-xs bg-slate-700 hover:bg-slate-600 text-white py-3 rounded-full font-medium transition-colors">
            Change Password
          </button>
        </div>
          ...
          <div className="space-y-3">
            {userInfo.map((item, index) => (
              <div key={index} className="flex justify-between items-center text-sm">
                ...
                <span className={item.isActive ? "text-green-400" : "text-white"}>
                  {item.value}
                </span>
              </div>
            ))}
        ...
        <div className="mb-8">
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4 space-y-4">
            {/* Referral Code */}
            <div>
              <label className="text-slate-400 text-sm mb-2 block">Referral Code</label>
            ...
            {/* Invite Link */}
            <div>
              <label className="text-slate-400 text-sm mb-2 block">Invite Link</label>
              <div className="flex items-center justify-between bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3">
