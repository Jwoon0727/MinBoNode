    ...
    >
      ...
      >
        <X size={14} />
            ...
            <button
              onClick={() => setShowEmailModal(false)}
              className="w-full bg-blue-600 bg-gradient-to-r from-blue-700 to-blue-800 hover:bg-blue-700 text-white py-3 rounded-full font-normal text-base transition-colors"
            >
              OK
            </button>
          </div>
